...
FOREIGN KEY (garages_id) REFERENCES garages (id) ON DELETE NO ACTION ON UPDATE NO ACTION,

primary key (id),
CONSTRAINT fk_plates,
FOREIGN KEY (plates_id) REFERENCES plates (id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
